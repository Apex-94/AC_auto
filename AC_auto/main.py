...
def process_img(og_img):
    ...
    processed_img = cv2.Canny(og_img, threshold1=100, threshold2=200)
    processed_img = cv2.GaussianBlur(processed_img, (3,3), 0)
    vertices = np.array([[10,500], [10,300], [300,200], [500,200] ,[800,300], [800,500]], np.int32)
    processed_img = roi(processed_img,[vertices])
    lines = cv2.HoughLinesP(processed_img, 1, np.pi/180, 180, np.array([]), 200, 5) #edges
    try:
        l1, l2 = draw_lanes(og_img, lines)
        cv2.line(og_img, (l1[0], l1[1]), (l1[2], l1[3]), [0, 255, 0], 30)
        cv2.line(og_img, (l2[0], l2[1]), (l2[2], l2[3]), [0, 255, 0], 30)
    except Exception as e:
        print(str(e))
        pass
    try:
...
with mss.mss() as sct:
    ...
    while "Screen capturing":
        ...
        #
        # ct=ct+1
        new_screen,og_img = process_img(screen)
        # Display the picture
